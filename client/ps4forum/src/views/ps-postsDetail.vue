          ...
          <div class="row" style="margin: 0;">
              <ul class="list-group" id="posts-detail-list">
                  ...
                  <li class="pull-left">
                      <div class="col-md-2 posts-detail-left">
                          <a href="#">
                              <img style="border-radius: 50%;" height="120px" width="120px" src="../assets/images/biggerhacker.jpg" alt="">
                          </a>
                          <h4>
                              <a href="#">Bigger Hacker</a>
                          </h4>
                      </div>
                      <div class="col-md-10 posts-detail-right">
                          <div class="posts-content">
